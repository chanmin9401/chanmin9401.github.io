...
last_modified_at: 2022-02-04 T19:00:00+09:00
...
|int getDayOfYear()|해당 날짜 객체의 일(DAY_OF_YEAR) 필드의 값을 반환|
...
📌 참고<br>
<http://tcpschool.com/java/java_time_localDateTime>{: target="_blank"}<br>
